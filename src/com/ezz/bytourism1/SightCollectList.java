...
public class SightCollectList extends BaseActivity implements OnItemClickListener,OnScrollListener{
...
//                    System.out.println("-----------------路线-----------------"+id);
                    ...
                    scenic.findObjects(SightCollectList.this, new FindListener<Scenic>() {
                        @Override
                        public void onSuccess(List<Scenic> sces) {
                            Scenic sce = sces.get(0);
                            String name = sce.getScenicname();
                            arr_data[0] = name;
                            simp_adapter = new SimpleAdapter(SightCollectList.this, getData(),
                                    R.layout.routescollect_item,new String[]{"pic","text","id"} ,new int[]{R.id.image,R.id.title,R.id.age});
//
                            listView.setAdapter(simp_adapter);
                            listView.setOnItemClickListener(SightCollectList.this);
                            listView.setOnScrollListener(SightCollectList.this);
                        }
                        @Override
